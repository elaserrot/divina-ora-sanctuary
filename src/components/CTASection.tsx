      ...
      <AnimatedSection>
        <div className="relative">
          ...
          <div className="relative space-y-8">
            <p className="text-sm tracking-[0.3em] uppercase text-primary">Tu momento</p>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-light leading-tight text-foreground">
              Tu transformación comienza cuando decides{" "}
              <span className="text-gradient-gold italic">escucharte</span>.
            </h2>
            <motion.div
