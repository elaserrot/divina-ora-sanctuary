...
const translations = {
  es: {
    ...
    kit1Desc: "Purificada con intención y cristales de cuarzo, esta esencia está pensada para armonizar tu entorno y elevar tu energía. Cada gota ha sido preparada con enfoque consciente, buscando limpiar las cargas densas, renovar la vibración de tu espacio y acompañarte en momentos de calma, claridad y equilibrio. Ideal para transformar cualquier ambiente en un lugar más ligero, sereno y lleno de buena intención.",
    kit2Name: "Alcohol Energético",
    kit2Desc: "Infusionado con hierbas sagradas, cuidadosamente seleccionadas por su simbolismo y poder ancestral. Diseñado para acompañar rituales de protección, limpieza y renovación, ayudando a liberar energías estancadas y fortalecer tu intención. Cada uso se convierte en un momento consciente para cerrar ciclos, proteger tu espacio y abrir camino a nuevas etapas con claridad, fuerza y equilibrio interior.",
    kit3Name: "Sal Ritual",
    kit3Desc: "Sal marina del Himalaya activada, preparada con intención consciente para potenciar sus propiedades purificadoras y protectoras. Ideal para sellar tu campo áurico después de cada limpieza energética, ayudando a estabilizar tu vibración y crear una barrera sutil frente a influencias externas. Úsala como un paso final en tus rituales para mantener tu energía firme, equilibrada y protegida a lo largo del día.",
    // Testimonials
